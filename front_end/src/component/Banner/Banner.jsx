...
const HeroBanner = () => {
  return (
    <>
      ...
      {/* NEWS SECTION */}
      <section className="new-section mt-5 mb-5">
        <div className="container">
          ...
          <p className="text-center text-muted mb-4">
            ...
            from street youth culture. Follow us to never miss the evolution of 
            urban and underground aesthetics.
          </p>
      ...
      <section className="branch-discovery-section mt-5 pt-5 pb-5">
        <div className="container">
            ...
            <div className="col-md-5">
              <div className="branch-info-content">
                <h2 className="brand-title">
                  EXPLORE OUR NATIONWIDE BRANCHES
                </h2>
      ...
      {/* HAIR ARTWORK SECTION */}
      <section className="hair-section mt-5 pt-1 pb-5">
        <div className="container">
          <h2 className="new-title text-center">ARTWORKS OF THE MONTH</h2>
          <p className="text-center text-muted mb-4">
            A collection of the most outstanding and creative men's hairstyles this week. 
      ...
      <div className="container mt-5">
        <h1 className="hero-title text-center mb-4">
          HAIR STYLING PARTNERSHIPS
        </h1>
        <p className="text-center text-muted mx-auto" style={{ maxWidth: '800px' }}>
          A compilation of famous game shows and events where NoName Barber has 
          collaborated as the official hair stylist. For partnership inquiries, please contact: 
          <strong> NoNameshop@gmail.com</strong>.
        </p>
      </div>
      <Movies />
    </>
